...
void handler_prova(){
    write(STDOUT_FILENO, "Questo è un messaggio di output standard\n", sizeof("Questo è un messaggio di output standard\n") - 1);
    fflush(stdout);
}

void handler_signal_fork(){
    //inizio simulazione
...
int main(int argc, char **argv){
    ...
    struct sigaction sa;
    sa.sa_handler = handler_signal_fork;
    sa.sa_flags = 0;
